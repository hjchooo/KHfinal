				...
				<div class="col-12">
					<table class="table">
						...
						<tbody>
							<tr>
								<td>From</td>
								<td><input type="text" id="from_id" name="from_id"
									class="form-control" value="${loginSession.id}" readonly>
								</td>
							</tr>
							<tr>
								<td>To</td>
								<td><input id="to_id" name="to_id" class="form-control"
									value="${writer_id}" readonly></td>
							</tr>
							<tr>
								<td>내용</td>
