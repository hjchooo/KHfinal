			...
			<div class="col-12">
				<table class="table">
					...
					<tbody>
						<tr>
							<td>From</td>
							<td><input type="text" class="form-control" id="from_id" name="from_id"
								value="${map.from_id}" readonly></td>
						</tr>
						<tr>
							<td>To</td>
							<td><input type="text" class="form-control" id="to_id" name="to_id"
								value="${map.to_id}" readonly></td>
						</tr>
						<tr>
							<td>내용</td>
							<td><textarea id="content" name="content"
									placeholder="내용을 입력하세요." class="form-control"></textarea></td>
						</tr>
						<tr>
							<td colspan="2">
								<div class="row">
