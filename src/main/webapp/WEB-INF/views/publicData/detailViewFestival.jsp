		...
		<div class="row margin_top_50">
			...
			<div class="row margin_bottom_50 titleAddr1">
				...
				<div class="row margin_top_20">
					...
					<div class="col-6">
						<span class="detail_info_text_bold">• 전화번호</span> &nbsp;&nbsp;&nbsp;
						<span class="detail_info_text">${dto.tel}</span>
					</div>
				...
				<div class="row margin_top_20">
					...
					<div class="col-6">
						<span class="detail_info_text_bold">• 축제시작</span> &nbsp;&nbsp;&nbsp;
						<!--실제 주소 들어가는 부분-->
						<span class="detail_info_text">${dto.eventstartdate}</span>
					</div>
					<div class="col-6">
						<span class="detail_info_text_bold">• 축제마감</span> &nbsp;&nbsp;&nbsp;
						<span class="detail_info_text">${dto.eventenddate}</span>
					</div>
